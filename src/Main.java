...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BMW bmw3 = new BMW("BMW 3i", CarTypes.COUPE, 2.5, Colors.SILVER, 2015, "Б/у", Fuel.PETROL);
        System.out.println(bmw3.getInfo());
        bmw3.makePrice("Нормальная цена.");
        System.out.println("************************************");

        BMW bmw5 = new BMW("BMW 530", CarTypes.SEDAN, 3.0, Colors.BLACK, 2020, "Новый", Fuel.DIESEL);
